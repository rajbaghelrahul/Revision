...
const fileOps = async () => {
    try {
        ...
        console.log(data);
        await fsPromises.writeFile(path.join(__dirname, 'files', 'deletingFile.txt'), data); // create for delete testing purpose.
        await fsPromises.unlink(path.join(__dirname, 'files', 'deletingFile.txt')); // for deleting command
